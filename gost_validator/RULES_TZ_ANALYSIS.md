...
- TITLE-004: указан регистрационный номер НИОКТР (RECOMMENDATION)
- TITLE-005: найден гриф УТВЕРЖДАЮ (CRITICAL)
- TITLE-006: после грифа УТВЕРЖДАЮ найдены инициалы (CRITICAL)
- TITLE-007: найден вид документа ОТЧЕТ О НИР (CRITICAL)
- TITLE-008: ОТЧЕТ О НИР написан в двух строках (CRITICAL)
- TITLE-009: ОТЧЕТ О НИР написан заглавными буквами (CRITICAL)
- TITLE-010: найден год (CRITICAL)
- TITLE-011: год <= текущего (CRITICAL)
- TITLE-012: найдено место (RECOMMENDATION)
...
- CONTENTS-004: есть ВВЕДЕНИЕ/ЗАКЛЮЧЕНИЕ/СПИСОК ИСТОЧНИКОВ (CRITICAL) 
...
- ABBR-004: в конце левой части не заканчиваеться знаками пунктуации (CRITICAL)
